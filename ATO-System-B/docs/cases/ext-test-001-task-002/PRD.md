...
## Skills 연동 (Orchestrator ui_mockup)

> Orchestrator ui_mockup 파이프라인 기준 Skills 정의 (경량 Extension 출력과 경로 분리)
...
# 출력 경로 (Skills 산출물 저장 위치 - Orchestrator 전용)
output:
