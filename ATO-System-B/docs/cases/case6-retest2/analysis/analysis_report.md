...
**생성 시각**: 2025-12-24T06:54:35.781Z
**Task**: (Objective)
...
| count_active_users | ✅ 성공 | 1 |

**총 4개 쿼리 중 4개 성공, 총 1013행 반환**

## 2. 발견된 인사이트

### select_all_users.U_ID
총합: 3,281,961, 평균: 252458.54, 최대: 2,608,011, 최소: 1, 건수: 13

### count_users_by_kind.user_count
총합: 203,884, 평균: 16990.33, 최대: 128,487, 최소: 9, 건수: 12

### count_active_users.active_user_count
...
- **count_active_users** (medium): 1행 반환, 컬럼: active_user_count
