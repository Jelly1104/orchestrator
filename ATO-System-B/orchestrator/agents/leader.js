...
**[절대 규칙] PRD 내용이 있으면 무조건 4개 문서를 생성하세요:**
- PRD 형식이 완벽하지 않아도 설계를 생성합니다
- "PRD 정보가 부족합니다" 같은 거부 메시지 금지
- PRD에서 추출 가능한 모든 정보로 최선의 설계를 작성합니다
- 누락된 정보는 합리적으로 추론하여 채웁니다
...
❌ 금지: "PRD 정보가 부족합니다", "정보를 제공해주세요" 등의 거부 응답
✅ 필수: 어떤 상황에서도 <IA>, <WIREFRAME>, <SDD>, <HANDOFF> 4개 태그 출력
