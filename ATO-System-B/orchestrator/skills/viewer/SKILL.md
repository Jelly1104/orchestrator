...
> **상태**: ✅ **운영 중**
> **변경 이력**: 네이밍 리팩토링 - Viewer-Agent → Viewer Skill
...
Reviewer Skill 결과를 시각적 성적표(Scorecard)로 표시:
...
```
ReviewerSkill.validate() → score < 80
        ↓
...
Reviewer Skill 반려 후 재작성 시 v1 ↔ v2 비교:
...
| Phase 5 | Reviewer Skill Scorecard 연동 | 📋 예정 |
