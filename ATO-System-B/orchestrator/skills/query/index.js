...
export class QuerySkill {
  ...
  async initialize() {
    ...
    console.log('[QuerySkill] Initialized with SKILL.md');
    return this;
  }
...
export default {
  create: (config = {}) => new QueryAgent(config),
  meta: {
    name: 'query-agent',
    version: '1.1.0',
    description: 'SQL 쿼리 생성 및 데이터 분석 전담',
    category: 'analyst',
    dependencies: ['SkillLoader', 'AnalysisAgent'],
    status: 'active'
  }
};
