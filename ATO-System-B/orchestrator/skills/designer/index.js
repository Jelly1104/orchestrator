...
export class DesignerSkill {
  ...
  async initialize() {
    ...
    console.log('[DesignerSkill] Initialized');
    return this;
  }
  ...
  async visualize(input) {
    ...
    console.log('[DesignerSkill] Starting visualization');
    ...
    try {
      ...
      console.log(`[DesignerSkill] Created ${results.files.length} visual files`);
    } catch (error) {
      console.error(`[DesignerSkill] Error: ${error.message}`);
