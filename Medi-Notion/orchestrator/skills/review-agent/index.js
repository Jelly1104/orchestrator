/**
 * ReviewAgent - 산출물 품질 검증 및 PRD 정합성 확인
 *
...
export class ReviewAgent {
   ...
   */
  async initialize() {
    this.skill = await this.skillLoader.loadSkill('review-agent');
    console.log('[ReviewAgent] Initialized with SKILL.md');
    return this;
  }
  ...
  async validate(input) {
    ...
    console.log('[ReviewAgent] Starting validation');
